...
function CardFlashcard(props) {
    ...
    const { createAction, handleConfirmDeleteFlashcard, data: { answer, question, id }, data } = props;
    return (
        <ReactCardFlip isFlipped={flip} className='flip' flipDirection="horizontal">
            <Card className={classes.card}>
                <CardHeader
                    ...
                    action={
                        <div className='card-action'>
                            <IconButton aria-label="settings" onClick={() => createAction('update', '', data)}>
                                <CreateIcon />
                            </IconButton>
                ...
                <CardActions disableSpacing>
                    <Button outline color="danger" className='center' onClick={() => {
                        setFlip(true)
                    }}>Flip</Button>
                </CardActions>
            </Card>
